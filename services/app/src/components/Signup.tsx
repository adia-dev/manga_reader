...
const Signup = () => {
  ...
  const alreadySignedIn = user !== null;
  if (alreadySignedIn) {
    return <Navigate to="/" />;
  }
  ...
  return (
    <div className="w-screen p-6 bg-dark-primary">
      <div className="flex h-screen bg-gray-100 border rounded-xl border-dark-primary">
        <div
          className="flex-auto w-1/2 bg-yellow-400"
          style={{
            backgroundImage:
              "url(https://i.pinimg.com/originals/df/aa/8e/dfaa8ebc002baefbd3b8b448723d76c9.png)",
        ...
        <div className="w-1/2 my-auto bg-gray-100">
          <form
            ...
            className="bg-gray-100 max-w-md mx-auto"
          >
            <h2 className="text-black text-4xl decoration-4">Welcome !</h2>
            <p className="text-gray-400 mt-2">Register account</p>
            ...
            <div className="flex flex-col mt-5">
              ...
              <input
                ...
                className="border-gray-300 rounded-md border-2 p-3 bg-gray-100 mt-2"
              />
            </div>
            <div className="flex flex-col mt-5">
            ...
            <div className="flex flex-col">
              <button className="mp-auto my-4 py-3 rounded-md bg-dark-tertiary text-gray-100">
                Sign up
              </button>
            </div>
            <p className="pt-3 text-center text-gray-500">
              Already have an account ?{" "}
              <Link to="/login" className="underline text-dark-tertiary">
                Sign in
              </Link>
            </p>
          </form>
