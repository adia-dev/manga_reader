...
async function getMangaInformation(id: any) {
  ...
  const altTitle = Object.values(
    data.attributes.altTitles?.[randomIdxAltTitles] ?? {}
  );
      ...
      <div className="container">
        ...
        <div className="stats">
          <span className="flex items-center text-yellow-400">
            <BiStar />
            <p className="ml-1">{results.rating}</p>
          </span>

          <span className="flex items-center text-orange-400">
            <BsBookmark />
            <p className="ml-1">{BeautifiedCount(results.saved_count)}</p>
          </span>
        </div>
